...
{{--                    </li>--}}
                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="{{ url('/user')}} " class="menu-link menu-toggle" >
                            <span class="svg-icon menu-icon">
                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="{{ url('/jurusan')}} " class="menu-link menu-toggle" >
                            <span class="svg-icon menu-icon">
                                <i class="flaticon-logout"></i>
                            </span>
                    ...
                    @endif
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="{{ url('/pendaftar')}} " class="menu-link menu-toggle" >
                            <span class="svg-icon menu-icon">
                                <i class="flaticon-logout"></i>
                            </span>
                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="{{ url('/pembayaran')}} " class="menu-link menu-toggle" >
                            <span class="svg-icon menu-icon">
                                <i class="flaticon-logout"></i>
                            </span>
