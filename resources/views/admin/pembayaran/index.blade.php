...
@push('jsScript')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.membayar', function () {
                var id = $(this).data("id");
                Swal.fire({
                    title: "Yakin Dia Telah Membayar ?",
                    icon: "question",
                    showCancelButton: true,
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "GET",
                            url: "{{ url($title) }}" + '/membayar/' + id,
                            success: function (data) {
                                loadpage('',5);
                                toastr.success("berhasil update status pembayaran!");
                            },
                            error: function (data) {
                                toastr.success("gagal update status pembayaran!");
                            }
                        });
                    }
                });
