        ...
        "
          ...
          ">
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="">
                        <!--begin::Form-->
                        <form class="form" method="POST" action="cetak-tes">
                            <!--begin::Title-->
                            @csrf
                            <!--begin::Title-->
                    ...
                    ">
                                ...
                                <p style="color:red" class="font-size-h5-lg">
                                        * {!! \Session::get('error') !!}</p>
                            @endif
                            </div>
                            <!--end::Title-->
                      ...
                      font-size-h6
                    "
                                    type="text" placeholder="Masukkan Nomor Induk Kependudukan Anda" name="nik"
                                    autocomplete="off" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            ...
                            <div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
                                ...
                                <button type="submit" id="cetakTes"
                                    class="
                      btn btn-primary
